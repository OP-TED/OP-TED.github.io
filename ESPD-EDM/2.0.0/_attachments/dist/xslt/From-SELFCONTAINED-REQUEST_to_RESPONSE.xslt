...
xmlns:util="java:java.util.UUID">	
	...
	<xsl:template name="createAnswer">
		...
		<xsl:if test="$propertyType = 'QUESTION'">
			...
			<cac:TenderingCriterionResponse>
					...
					<cbc:ValidatedCriterionPropertyID schemeID="CriteriaTaxonomy" schemeAgencyID="EU-COM-GROW" schemeVersionID="02.00.00"><xsl:value-of select="cbc:ID"/></cbc:ValidatedCriterionPropertyID>
	...
	<xsl:template name="generateID">
		<cbc:ID schemeID="ISO/IEC 9834-8:2008 - 4UUID" schemeAgencyID="EU-COM-GROW" schemeVersionID="02.00.00">
