...
.TED Open Data
****
Query TED Open Data through our SPARQL endpoint or download TED notice XML files directly. Reuse our RML (RDF Mapping Language) mappings to transform XML notices into RDF.
